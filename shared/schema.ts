...
export const categoryEnum = pgEnum('category', ['bug', 'feature', 'documentation', 'security', 'performance','environmentError','missingAccess','invalidTestData','notADefect','observation','duplicate']);
...
export const CATEGORY_VALUES = ['bug', 'feature', 'documentation', 'security', 'performance', 'environmentError','missingAccess','invalidTestData','notADefect','observation','duplicate'] as const;
