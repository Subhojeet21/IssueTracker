...
const issueSchema = new Schema({
  ...
  category: { 
    type: String, 
    enum: ['bug', 'feature', 'documentation', 'security', 'performance', 'environmentError', 'missingAccess','invalidTestData','notADefect','observation','duplicate'],
    default: 'bug'
  },
  team: {
    type: String,
    enum: ['compass', 'meta', 'everest'],
    default: 'compass'
  },
  environment: {
    type: String,
